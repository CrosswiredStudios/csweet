...
- Development and production runtime paths use Postgres via `ConnectionStrings:Postgres` or Aspire's `ConnectionStrings:csweet`; tests override the context with EF Core InMemory.
