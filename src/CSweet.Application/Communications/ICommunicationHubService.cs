...
public interface ICommunicationHubService
{
    ...
    Task<CommunicationHubMessageResponse?> SendAsync(Guid organizationId, Guid chatId, Guid actorOrganizationUserId, SendCommunicationMessageRequest request, CancellationToken cancellationToken = default);
}
